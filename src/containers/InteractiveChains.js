...
const mapDispatchToProps = dispatch => ({
  ...
  blockchainDispatch: chainAlias => action => dispatch(chainDispatch(chainAlias, action)),
});

const generateChainName = chain =>
  (chain.state && chain.state.chainMetadata ? chain.state.chainMetadata.chainName : chain.chainAlias);
...
InteractiveChains.defaultProps = {
  selectedChain: null,
};
